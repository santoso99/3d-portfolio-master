...
const experiences = [
  {
    ...
    date: "2015 - Present",
    details: [
      "Built a subscriber base of over <span style='color: white;'>500,000 subscribers</span> by creating video content to have fun.",
      "Crafted visually appealling videos that have garnered over <span style='color: white;'>30,000,000 views</span>.",
